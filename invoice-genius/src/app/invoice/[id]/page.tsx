          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="text-right">
              ...
              <div className="text-gray-300">
                ...
                <div><strong>HSC Code:</strong> {invoice.hscCode}</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="w-80">
              <div className="space-y-2">
                ...
                {/* Tax Information */}
                {invoice.taxType === 'interstate' ? (
                  // Interstate - IGST
                  invoice.igstRate > 0 && (
                    <div className="flex justify-between py-2">
                      <span className="text-gray-300">IGST ({invoice.igstRate}%):</span>
                      <span className="font-semibold text-white">
                  ...
                  <>
                    {invoice.cgstRate > 0 && (
                      <div className="flex justify-between py-2">
                        <span className="text-gray-300">CGST ({invoice.cgstRate}%):</span>
                        <span className="font-semibold text-white">
                    ...
                    {invoice.sgstRate > 0 && (
                      <div className="flex justify-between py-2">
                        <span className="text-gray-300">SGST ({invoice.sgstRate}%):</span>
                        <span className="font-semibold text-white">
